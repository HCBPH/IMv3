...
public class IMConfiguration {
    ...
    public static String ADDR_SERVER = "1.117.74.41";
    public static int PORT_SERVER = 29233;
    public final static long UID_SERVER = 0L;
    public static long UID_SELF = 4L;
    public static String PASSWORD_SELF = "123456";
    public static String USERNAME_SELF = "mobile";
